...
public class TodayFlightDetailView extends UserEntryView implements View {
    ...
    private void fillFlightData(){
        List<DepartureFlight> departureFlightList = (List<DepartureFlight>)connection.getAllValuesNoRecordStatus("com.back.office.entity.DepartureFlight");
        List<ArrivalFlight> arrivalFlightList = (List<ArrivalFlight>)connection.getAllValuesNoRecordStatus("com.back.office.entity.ArrivalFlight");
